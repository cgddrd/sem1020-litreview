...
%In examining the suitability of strict liability to case of autonomous vehicles, Duffy and Hopkins make reference to an unlikely case subject in the form of the existing liability laws surrounding canine ownership \cite{duffy}.  
...
%draw on an unlikely association between the laws surrounding ownership of computers and dogs
...
% which may result in them undertaking behaviour that cannot necessarily be attributed to the  of their owners  \cite{duffy}.
...
%An alternative point of view raised by Gurney \cite{gurney},  
...
%impacts that this may have on the incentives of manufacturers


   

%
%of clear impartiality and a strong understanding of the implications that the various positive and negative incentives will have on 
...
%The dilemma facing law makers who are tasked with determining responsibility in the case of driverless vehicle accidents, 
%
%The issue of assigning responsibility to one or either the driver or manufacturer in the case of driverless vehicle accidents represents a significant dilemma  
%
%
%
%contenious issue on both sides of the argument
%
%and/or the distribution of liability costs across the consumer market



%that may be used to enforce prosecution against them in the event of damage or injury they may cause \cite{duffy}. Instead, both are deemed to be the personal property (chattel) of their owner, who - as someone recognised as having a legal identity - is automatically held accountable in the case of that either 
%
%being the personal property (chattel) of their owner, and as such are not deemed to hold legal standing that could be  
%
%
%neither a computer nor a dog can be deemed to be a legal person in their own right, 

%Providing one of the first comprehensive law reviews examining the liability implications arising from the introduction of driverless technotlogies, Marchant and Lindor \cite{marchant} suggest manufacturers could potentially use 
%
%one approach to protecting manufacturers from further liability could be to 
%
%
%
% vehicle owners as the significant liable party through the existing defence of \textit{assumed risk}.
...
%
%Published in 2012, the work of  was one the first papers to focus . In support of their the need to protect manufacturers from increased liability, the authors introduce three alternative legal and policy mechanisms for offering protection to manufacturers against increased liability. 
...
%their exists a strong consensus as to the need for a significant overhaul of existing policies, laws and technical standards in order to prepare for the novel - and yet unencountered - challenges associated with successfully integrating autonomous vehicles into our existing democratic societal systems. 
...
%Whilst the works studied for this report share a agreement as to the need for revision of our existing legal frameworks so that they may govern where liability should be placed in the event of a `driverless' crash, ideas and opinions begin to diverge when discussion turns toward what types of changes are likely to be required, and how these should be implemented in order to guarantee the balance between fairness and rightful justice in such cases. 
%
%%and - perhaps more importantly - how these should be implemented to ensure a fair comprise between accepting responsibl.
%
%A paper commonly cited in discussions surrounding the legal aspects of autonomous vehicles is that of the work by Marchant and Lindor \cite{marchant}, in which the authors discuss in exacting detail, their predictions relating to how, and in what form, the legal system can be expected to evolve, in order to establish fair and practical measures for determining legal liability in future traffic incidents. Within their work, the authors discuss the introduction of autonomous driving systems is set to trigger a profound shift in the dynamics associated with apportioning responsibility for a crash involving an autonomous vehicle.
%
%By replacing the driver with a software equivalent, the authors argue that manufacturers will implicitly redirect greater legal responsibility onto themselves (and potentially their suppliers), under the premise that the cause of a vehicle crash, whilst operating under autonomous control, could no longer be attributable to human error, and instead would 
%
%%In either case, manufacturers can expect to see a substantial increase in the number and severity of liability cases brought against them. 
%
%With manufacturers naturally set to exhibit trepidation toward the substantial increase in the number and severity of liability cases brought against them, the authors highlight that this situation poses a potentially detrimental barrier to the mainstream introduction of autonomous vehicles, extending beyond those raised through any remaining technical limitations or economic factors \cite{marchant}. 
%
%One of the key discussion topics found across many papers, 
%previously determined to be the result of human error, to now fall
 
%The potential consequences arising from vehicle accidents demonstrate no regard for who - or what - held 
%
%Regardless of whether an accident is the cause of human or software error, the potential consequences that can ensue remain the same; ranging from minor vehicle or property damage caused to one or both parties; up to in the most severe cases, the loss of human life. 


% In particular, this section looks to analyse how the impacts of increased liability upon manufacturers may affect the approach and attitude taken towards the design, implementation, testing and deployment of driverless software.
